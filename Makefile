# ----------------------------------------
# Makefile Deployment Targets for RoboShop
# ----------------------------------------
# default  : Deploys a service to the development environment using Ansible.
# tool     : Deploys an internal tool using Ansible.
